...
Projet 03 de la série **100 projets en 1 an**

---

## ✨ Fonctionnalités

* Pouvoir génerer un code QR pour n'importe quel lien
...
* **CSS & TailwindCss** : Stylisation et mise en page
*  **React-qr-code** : pour la géneration du code qr 
...
1. **Cloner le projet** :
   ...
   ```bash
   git clone https://github.com/dagbokady/03-Generateur-de-code-Qr.git
   ```
